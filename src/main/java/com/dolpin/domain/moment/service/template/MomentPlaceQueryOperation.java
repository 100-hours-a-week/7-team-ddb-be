...
@Slf4j
@Component
public class MomentPlaceQueryOperation extends MomentQueryTemplate {

    public MomentPlaceQueryOperation(MomentRepository momentRepository,
    ...
    protected String generateBaseUrl(MomentQueryContext context) {
        return "/api/v1/places/" + context.getPlaceId() + "/moments";
    }

    @Override
    protected boolean shouldIncludeAuthor(MomentQueryContext context) {
        return true; // 장소별 기록 조회 시 작성자 정보 포함
    }
}
